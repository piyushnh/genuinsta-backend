...
SOCIAL_AUTH_INSTALLED_APPS = [
    ...
    # if you use the same token auth system as the example
...
#             'GOOGLE_OAUTH2_SECRET',  ##ORIGINALLY THIS##
#             'FACEBOOK_KEY',
#             'FACEBOOK_SECRET']:
# for key in ['GOOGLE_OAUTH2_KEY',
...
SOCIAL_AUTH_GOOGLE_OAUTH_KEY = '449128478291-90ddc7ig449n9m79lttsvnf0c0o4imtc.apps.googleusercontent.com'
SOCIAL_AUTH_GOOGLE_OAUTH_SECRET = '0SgeuYh6o4jH7CDdt9etKF3O'
