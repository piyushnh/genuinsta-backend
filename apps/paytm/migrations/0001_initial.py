# Generated by Django 2.1.7 on 2019-05-11 09:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CUST_ID', models.CharField(max_length=64, verbose_name='CUST_ID')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='paytm_payment', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
