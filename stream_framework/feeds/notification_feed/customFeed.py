...
class CustomNotificationFeed(BaseFeed):
    '''
    ...
    def __init__(self, user_id, **kwargs):
        super(CustomNotificationFeed, self).__init__(user_id, **kwargs)
    ...
    def get_activity_slice(self, start=None, stop=None, rehydrate=True):
        ...
        '''
        activities = super(CustomNotificationFeed, self).get_activity_slice(start, stop, rehydrate)
    ...
    def add_many_aggregated(self, aggregated, *args, **kwargs):
        ...
        '''
        super(CustomNotificationFeed, self).add_many_aggregated(aggregated, *args, **kwargs)
    ...
    def remove_many_aggregated(self, aggregated, *args, **kwargs):
        ...
        '''
        super(CustomNotificationFeed, self).remove_many_aggregated(aggregated, *args, **kwargs)
        ids = [a.serialization_id for a in aggregated]
    ...
    def delete(self):
        ...
        '''
        super(CustomNotificationFeed, self).delete()
