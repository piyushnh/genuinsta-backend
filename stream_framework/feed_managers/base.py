...
class Manager(object):
    ...
    **Example** ::
    ...
    def follow_user(self, user_id, target_user_id, is_async=True):
        '''
        ...
        :param is_async: controls if the operation should be done via celery
        '''
        self.follow_many_users(user_id, [target_user_id], is_async)

    def unfollow_user(self, user_id, target_user_id, is_async=True):
        '''
        ...
        :param is_async: controls if the operation should be done via celery
        '''
        self.unfollow_many_users(user_id, [target_user_id], is_async)

    def follow_many_users(self, user_id, target_ids, is_async=True):
        '''
    ...
    def unfollow_many_users(self, user_id, target_ids, is_async=True):
        '''
